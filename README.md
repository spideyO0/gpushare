...
├── python/gpushare_hook.py           # PyTorch startup hook (auto-patches torch.cuda)
├── python/gpushare.pth               # Triggers hook at Python startup
...
│   ├── fooocus_gpu_patch.py           # GPU detection for PyTorch launchers
