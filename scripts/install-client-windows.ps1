...
Write-Host "  Transfer opts:   " -NoNewline; Write-Host "ACTIVE" -ForegroundColor Green -NoNewline; Write-Host " (tiered pinned pools, async memcpy, chunked pipelining, D2H prefetch, modular transport)"
